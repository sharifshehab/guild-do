      ...
      <>
        ...
        <Container>
          <section className="w-full min-h-screen flex flex-col items-center justify-center py-5">
            ...
            {/* form area */}
            <form
              className="w-full bg-secondaryColor p-10"
                ...
                <div className="flex flex-col sm:flex-row items-center gap-5">
                  <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                    <label className="relative">
                      <input
                        type="number"
                        className="peer text-white bg-darkColor border-[#e5eaf2] border outline-none ps-36 pe-5 py-3 w-full focus:border-yellow-400 transition-colors duration-300"
                        {...register("phone", {
                  ...
                  <div className="flex flex-col gap-[5px] w-full sm:w-[50%]">
                    <label className="relative">
                      <input
                        type="text"
                        className="peer text-white bg-darkColor border-[#e5eaf2] border outline-none ps-32 pe-5 py-3 w-full focus:border-yellow-400 transition-colors duration-300"
                        {...register("address", {
            ...
            <div className="section-title bg-yellow-400 inline-block px-6 p-2 mt-10 title-cut hover:bg-yellow-500 duration-300">
              <Link to={"/"} className="text-darkColor font-bold ">
                Go To Home Page
              </Link>
            </div>
