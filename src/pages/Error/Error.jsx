...
const Error = () => {
    return (
        <>
            ...
            <main>
                <section className="min-h-screen bg-yellow-400 my-0 flex items-center justify-center">
                    ...
                    <div className="boxShadow px-10 w-full flex items-center flex-col justify-center pb-[50px] rounded-xl">
                        ...
                        <Link to={'/'}>
                            <button
                                className="py-3 px-6 sm:px-8 bg-[#fff] text-[#1C3177] border border-[#1C3177] mt-4 flex items-center gap-[10px]">
