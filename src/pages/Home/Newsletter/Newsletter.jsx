    ...
    <section>
      <Container>
          ...
          <div className="relative mt-10 w-full mx-auto">
            ...
            />
            <button className="font-semibold py-3 px-6 h-full absolute top-0 right-0 bg-yellow-400 hover:bg-yellow-500 border-l-2 border-se text-secondaryColor transition-all duration-300 prev-cut">
              Subscribe
            </button>
          </div>
